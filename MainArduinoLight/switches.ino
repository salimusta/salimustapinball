...
void ReadSwitches() {
  ...
  bool newLOSW, newRLOSW, newLLOSW, newCT, newCTP, newRT1, newRT1P, newRT2, newLT1, newLT2, newLT2P, newKO1, newRAMP;
  ...
  while (Wire.available())   // slave may send less than requested
  {
    ...
    newROSW2 = (c & 16) >> 4; newROSW3 = (c & 32) >> 5; newTRIEUR = (c & 64) >> 6; newKO2 = (c & 128) >> 7;
    ...
    TRIEUR = (newTRIEUR && TRIEUR_Old != newTRIEUR); KO2 = (newKO2 && KO2_Old != newKO2);
    LOSW = (newLOSW && LOSW_Old != newLOSW); RLOSW = (newRLOSW && RLOSW_Old != newRLOSW); LLOSW = (newLLOSW && LLOSW_Old != newLLOSW);
    CT = (newCT && CT_Old != newCT); CTP = (newCT && CTP_Old != newCTP); RT1 = (newRT1 && RT1_Old != newRT1);
    RT1P = (newRT1P && RT1P_Old != newRT1P); RT2 = (newRT2 && RT2_Old != newRT2); LT1 = (newLT1 && LT1_Old != newLT1); LT2 = (newLT2 && LT2_Old != newLT2);
    LT2P = (newLT2P && LT2P_Old != newLT2P); KO1 = (newKO1 && KO1_Old != newKO1); RAMP = (newRAMP && RAMP_Old != newRAMP);
  }
  ...
  RT2_Old = newRT2; LT1_Old = newLT1; LT2_Old = newLT2; LT2P_Old = newLT2P; KO1_Old = newKO1; RAMP_Old = newRAMP;
}
...
void ReadSolenoidSwitches() {
  ...
  while (Wire.available()) {
    char c = Wire.read(); // receive a byte as character
    newKickerLeft = (c & 1);
    newKickerRight = (c & 2) >> 1;
    newLeftFlipper = (c & 4) >> 1;
    newRightFlipper = (c & 8) >> 1;
